<?php
namespace toinclude\PLUSPEOPLE\PesaPi;
set_include_path("../toinclude:" . get_include_path());
require_once("../toinclude/PLUSPEOPLE/autoload.php");
...
namespace toinclude\PLUSPEOPLE;
//require_once("../toinclude/PLUSPEOPLE/SlowTemplate/Template.php");
class configtool extends SlowTemplate\Template {
